...
so the hair and suit don't disappear against the navy background. As you scroll,
the same points morph between four shapes — portrait, sphere, torus knot, tilted
grid — and fade back to the portrait on the contact section. Three.js r128 loads
from cdnjs.
